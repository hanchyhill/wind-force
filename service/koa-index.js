...
router.get('/api',async(ctx,next)=>{
  ...
  if(ctx.query.interface=='getWind'){
    ...
    // http://172.22.1.175/di/grid.action?userId=sqxt&pwd=shengqxt123&dataFormat=json&interfaceId=intGetMultElesDataTimeSerial&modelid=ecmwfthin&element=u10m v10m t2mm visi&level=0&starttime=2020-06-15 12:00:00&endtime=2020-06-17 12:00:00&lon=112.25&lat=21.5
